...
int accept(int s, void *addr, void *addrlen) __THROW;
int connect(int sockfd, void *serv_addr, int addrlen) __THROW;
int bind(int sockfd, void *my_addr, int addrlen) __THROW;
